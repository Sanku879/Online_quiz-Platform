...
public class Python_Rules extends JFrame implements ActionListener{
    
    JButton Start,Back;
    String name;
    
    public Python_Rules(String name) {
        this.name=name;
...
//        add(Back);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Quiz Image/Python.png"));
        ...
        ImageIcon img = new ImageIcon("C:\\Users\\DELL\\OneDrive\\Documents\\NetBeansProjects\\Quiz Application\\src\\Quiz Image\\Python Background.png");
